      ...
      >
        <div className="w-full">
          ...
          <button
            ...
            className="mt-2 w-full transform rounded-lg bg-blue-600 px-4 py-2 text-white transition-transform hover:scale-105 focus:ring-2 focus:ring-blue-600 focus:outline-hidden sm:mt-4"
          >
            Submit Code
          </button>
        </div>
