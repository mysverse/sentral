...
export default function RobloxAvatarDisplay({
  ...
  return (
    <SignOutButton redirectUrl="/auth/login">
      <a className="group block shrink-0 transition hover:cursor-pointer hover:opacity-80">
        <div className="flex flex-row items-center lg:flex-row-reverse">
          {image && (
            <Image
              className="inline-block h-14 w-14 rounded-full bg-gray-100 drop-shadow-xs lg:h-10 lg:w-10"
              src={image}
