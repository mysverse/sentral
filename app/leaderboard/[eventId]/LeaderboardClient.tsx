...
import { readFetcher } from "components/swr";
...
export default function LeaderboardClient({
  ...
  const leaderboardKey = `/api/leaderboard/${encodeURIComponent(eventId)}`;
  const { data: leaderboard = initialLeaderboard, mutate: mutateLeaderboard } =
    useSWR<LeaderboardEntry[]>(leaderboardKey, readFetcher, {
  ...
  }, [eventId, reconnectTrigger, reconnectSSE, mutateLeaderboard]);
